...
The window manager [i3](https://github.com/abxh/dotfiles/tree/main/i3/i3) is used with [sxhkd](https://github.com/abxh/dotfiles/tree/main/sxhkd), which sets all the keybindings except modes.
